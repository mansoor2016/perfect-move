...
Revision ID: 2b00395aa7d8
Revises: 
Create Date: 2025-08-20 22:41:20.473384
...
def upgrade() -> None:
    ...
    op.create_index('idx_amenities_category', 'amenities', ['category'], unique=False)
    op.create_index('idx_amenities_location', 'amenities', ['location'], unique=False, postgresql_using='gist')
    op.create_index('idx_amenities_subcategory', 'amenities', ['subcategory'], unique=False)
    op.create_table('environmental_data',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('location', geoalchemy2.types.Geography(srid=4326, from_text='ST_GeogFromText', name='geography', nullable=False), nullable=False),
    ...
    op.create_index('idx_environmental_area_name', 'environmental_data', ['area_name'], unique=False)
    op.create_index('idx_environmental_data_location', 'environmental_data', ['location'], unique=False, postgresql_using='gist')
    op.create_index('idx_environmental_location', 'environmental_data', ['location'], unique=False, postgresql_using='gist')
    ...
    op.create_index('idx_properties_last_updated', 'properties', ['last_updated'], unique=False)
    ...
    op.create_index('idx_properties_source_id', 'properties', ['source', 'source_id'], unique=False)
    ...
    op.create_index('idx_saved_properties_property_id', 'saved_properties', ['property_id'], unique=False)
    op.create_index('idx_saved_properties_unique', 'saved_properties', ['user_id', 'property_id'], unique=True)
    op.create_index('idx_saved_properties_user_id', 'saved_properties', ['user_id'], unique=False)
    ...
    op.create_index('idx_saved_searches_notifications', 'saved_searches', ['notifications_enabled', 'last_notification_sent'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_saved_searches_notifications', table_name='saved_searches')
    op.drop_table('saved_searches')
    op.drop_index('idx_saved_properties_user_id', table_name='saved_properties')
    op.drop_index('idx_saved_properties_unique', table_name='saved_properties')
    op.drop_index('idx_saved_properties_property_id', table_name='saved_properties')
    op.drop_table('saved_properties')
    op.drop_index('idx_users_email', table_name='users')
    op.drop_table('users')
    op.drop_index('idx_properties_source_id', table_name='properties')
    ...
    op.drop_index('idx_properties_last_updated', table_name='properties')
    op.drop_index('idx_properties_bedrooms', table_name='properties')
    op.drop_table('properties')
    op.drop_index('idx_environmental_location', table_name='environmental_data', postgresql_using='gist')
    op.drop_index('idx_environmental_data_location', table_name='environmental_data', postgresql_using='gist')
    op.drop_index('idx_environmental_area_name', table_name='environmental_data')
    op.drop_table('environmental_data')
    op.drop_index('idx_amenities_subcategory', table_name='amenities')
    op.drop_index('idx_amenities_location', table_name='amenities', postgresql_using='gist')
